...
class EmailGenerator:
    ...
    def generate_html_email(self, papers, summaries, date_str, api_url=''):
        ...
        Args:
            ...
            api_url: Base API URL for unsubscribe links
        ...
        return self._build_html_template(paper_sections, date_str, len(papers), api_url)
    
    def generate_plain_text_email(self, papers, summaries, date_str, api_url=''):
    ...
    def _build_html_template(self, paper_sections, date_str, num_papers, api_url):
        ...
        Args:
            ...
            api_url: Base API URL for unsubscribe link
            
        Returns:
            str: Complete HTML email template
        """
        unsubscribe_link = f"{api_url}/unsubscribe" if api_url else "#"
